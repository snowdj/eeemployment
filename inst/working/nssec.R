...
cleaned_subset_2016 <- raw_subset_2016 %>%
  ...
  dplyr::mutate(NSECMJ10 = as.character(haven::as_factor(NSECMJ10))) %>%
...
openxlsx::write.xlsx(nssec, "nssec.xlsx")
